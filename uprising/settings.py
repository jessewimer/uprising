...
CROPS = ['AMARANTH', "BACHELOR'S BUTTON", 'BASKET FLOWER', 'BORAGE', 'BUPLEURUM', 'CALENDULA', 'CELOSIA', 'CERINTHE', 'CHINA ASTER', 
         ...
         'POPPY', 'RUDBECKIA', 'RUDBECKIA TRILOBA', 
         'SAINFOIN', 'SALVIA', 'SAPONARIA', 'SCABIOSA', 'SIBERIAN YARROW', 'SNAPDRAGON', 'STRAWFLOWER', 'SUNFLOWER', 'SUNFLOWER, MEXICAN', 
         'SWEET PEA', 'ZINNIA', 'BASIL', 'CHERVIL', 'CILANTRO', 'CULINARY HERBS', 'DILL', 'ECHINACEA', 
         'GERMAN CHAMOMILE', 'HYSSOP', 'LICORICE MINT', 'MARIGOLD', 'MARSHMALLOW', 'MONARDA', 'MULLEIN', 'NEPITELLA', 'NIGELLA SATIVA', 'OREGANO',
         'PARSLEY, FLATLEAF', 'TRIGONELLA', 'AMARANTH GREENS', 'BEAN', 'FAVA BEAN', 
         'BEAN, GARBANZO', 'BEAN, MISC', 
         'BEET', 'BEET, SPECIALTY', 'BOK CHOI', 'BROCCOLI', 'BURDOCK', 'CABBAGE', 'CABBAGE, FALL', 'CABBAGE, NAPA', 'CABBAGE, SUMMER', 'CABBAGE, WINTER', 
