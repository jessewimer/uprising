...
# NOTES:
# Need to decide on endive: curly vs others...
# Need to decide on greens, onions
CROPS = ['AMARANTH', "BACHELOR'S BUTTON", 'BASKET FLOWER', 'BORAGE', 'BUPLEURUM', 'CALENDULA', 'CELOSIA', 'CERINTHE', 'CHINA ASTER', 
         ...
         'POPPY', 'RUDBECKIA', 'RUDBECKIA TRILOBA', 'SAINFOIN', 'SALVIA', 'SAPONARIA', 'SCABIOSA', 'SIBERIAN YARROW', 'SNAPDRAGON', 
         'STRAWFLOWER', 'SUNFLOWER', 'SUNFLOWER, MEXICAN', 'SWEET PEA', 'ZINNIA', 'BASIL', 'CHERVIL', 'CILANTRO', 'CULINARY HERBS', 'DILL', 
         'ECHINACEA', 'GERMAN CHAMOMILE', 'HYSSOP', 'LICORICE MINT', 'MARIGOLD', 'MARSHMALLOW', 'MONARDA', 'MULLEIN', 'NEPITELLA', 'NIGELLA SATIVA', 'OREGANO',
         'PARSLEY, FLATLEAF', 'TRIGONELLA', 'AMARANTH GREENS', 'BEAN', 'FAVA BEAN', 'BEAN, GARBANZO', 'BEAN, MISC', 'BEET', 'BOK CHOI', 'BROCCOLI', 'BURDOCK', 'CABBAGE', 
         'CARDOON', 'CARROT', 'CAULIFLOWER', 'CELERIAC', 'CHICORY', 'CHRYSANTHEMUM/SHUNGIKU', 'COLLARDS', 'CORN', 'CUCUMBER', 'CURLY ENDIVE', 'EGGPLANT', 'ENDIVE, BELGIAN', 'ENDIVE, CURLY', 'ESCAROLE', 'FENNEL (FINOCCHIO)', 
         'GREENS, ARUGULA', 'GREENS, ASIAN', 'GREENS, CRESS', 'GREENS, MESCLUN', 'GREENS, MUSTARD', 'GREENS, SPECIALTY', 'GROUND CHERRY', 'KALE', 
         'LEAF BROCCOLI', 'LEEK', 'LENTIL', 'LETTUCE', 'MELON', 'MIXED GREENS', 'ONION, RED STORAGE', 'ONION, SCALLION', 'ONION, STORAGE', 
         'ONION, SWEET', 'PARSNIP', 'PEA', 'PEA, COWPEA', 'PEPPER', 'PEPPER, HOT', 'PEPPER, SWEET', 'RADICCHIO', 'RADISH', 'RAPINI/CIMA DI RAPA', 'SHALLOT', 'SORREL', 'SPINACH', 
         'STRAWBERRY', 'SUMMER SQUASH', 'SWEET LUPINE', 'SWISS CHARD', 'TOMATILLO', 'TOMATO', 'WATERMELON', 'WHEAT', 'WHEAT, EMMER', 'WINTER SQUASH', 'WINTER SQUASH, PUMPKIN']
...
#              "MORNING GLORY", "MULLEIN", "NASTURTIUM", "NICOTIANA", "NIGELLA", "OREGANO", "PHACELIA", "POPPY", "RUDBECKIA",
...
SUBTYPES = ["AMARANTH", "ARUGULA", "ASIAN", "BIBB/ROMAINE", "BRAISING", "BREADSEED", "BUTTERHEAD", "CALIFORNIA",
            ...
            "DRY/SOUP", "FALL/WINTER", "FAVA", "FINOCCHIO", "FLATLEAF", "FLOUR", "GERMAN", "GOLD", "GREEK", "HOT", "HOT/SWEET",
            "ICELAND", "LOOSELEAF", "MESCLUN", "MEXICAN (TITHONIA)", "NAPA", "OAKLEAF", "ORNAMENTAL", "PASTE",
            "PEARL", "PEONY", "PERSIAN", "PICKLING", "PIE", "POPPING", "PURPUREA", "RAINBOW", "RAPINI", "RED", "ROMAINE",
            "SACRED", "SALADETTE", "SCALLION", "SHALLOT", "SHELLING", "SHIRLEY", "SHUNGIKU", "SIBERIAN", "RUNNER",
