...
CROPS = ['AMARANTH', "BACHELOR'S BUTTON", 'BASKET FLOWER', 'BORAGE', 'BUPLEURUM', 'CALENDULA', 'CELOSIA', 'CERINTHE', 'CHINA ASTER', 
         ...
         'CARDOON', 'CARROT', 'CAULIFLOWER', 'CELERIAC', 'CHICORY', 'CHRYSANTHEMUM/SHUNGIKU', 'COLLARDS', 'CORN', 'CORN, SWEET', 'CUCUMBER', 'CUCUMBER, PERSIAN', 'CURLY ENDIVE', 'EGGPLANT', 'ENDIVE, BELGIAN', 'ENDIVE, CURLY', 'ESCAROLE', 'FENNEL (FINOCCHIO)', 
         ...
         'STRAWBERRY', 'SUMMER SQUASH', 'SWEET LUPINE', 'SWISS CHARD', 'TOMATILLO', 'TOMATO', 'TOMATO, CHERRY', 
